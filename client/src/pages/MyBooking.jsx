...
const MyBooking = () => {
  ...
  return (
    ...
    <div className='py-28 md:pb-35 px-12 '>
        ...
        <div className='max-w-6xl mt-8 w-full text-gray-800'>
            <div className='hidden gap-10 md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3 pl-50'>
